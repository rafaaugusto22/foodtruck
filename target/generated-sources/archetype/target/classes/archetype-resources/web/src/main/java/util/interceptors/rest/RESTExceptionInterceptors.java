...
import ${package}.util.exceptions.BadRequestException;
import ${package}.util.exceptions.ConflictException;
import ${package}.util.exceptions.NotAcceptableException;
import ${package}.util.exceptions.RequestTimeOutException;
import ${package}.util.exceptions.ResourceError;
//import ${package}.util.exceptions.UnauthorizedException;
